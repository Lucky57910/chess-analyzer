...
def main() -> None:
    try:
        ...
        # `analyse_pgn` keeps the engine process alive in a module global for
        # reuse across games. Without this the script writes its output and
        # then hangs forever waiting on a child that was never told to quit.
        engine.close_engine()
